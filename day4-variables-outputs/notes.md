...
**Next up -> [Day 5: State Management](../day5-state-management/notes.md)** - where Terraform actually *remembers* what it built, and how to keep that memory safe and shared.
