...
**Next up →** [Day 9: Capstone Project](../day9-capstone-project/notes.md) - put everything together and build a complete VPC + EC2 + RDS infrastructure with modules, remote state, and dev/prod separation.
