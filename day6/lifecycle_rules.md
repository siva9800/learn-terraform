...
> **Goal:** Go deeper than the Day 6 overview into the `lifecycle` block - exactly *when* each rule fires, what order Terraform does things in, and the traps to avoid. This is a companion to **[Day 6: Meta-Arguments & Lifecycle](./readme.md)**.
...
**Back to [Day 6: Meta-Arguments & Lifecycle](./readme.md)** | **Next up -> [Day 7: Modules](../day7/readme.md)**
